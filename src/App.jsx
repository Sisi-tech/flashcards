      ...
      <div className='grid lg:grid-cols-2 sm:grid-cols-1 leading-loose '>
        <div className='pl-4'>
          ...
          <div onClick={handleShowAnswer} 
            className={`${showAnswer ? 'pointer-events-none' : ''} border border-gray-700 shadow-sm shadow-gray-500 w-[700px] pl-4 pr-4 h-[200px] flex justify-center items-center mt-8 rounded-md animate-pulse`} 
            style={{backgroundColor: `${plantData[cardId].color}`}}
          >
          ...
          <div className='flex gap-8 justify-center pt-10'>
            <button 
              type="button" 
              className='text-white bg-rose-300 w-[70px] text-3xl rounded-full shadow-md shadow-[#ffe4e6] hover:bg-[#f43f5e] active:bg-[#e11d48] focus:outline-none focus:ring focus:ring-[#fecdd3]'
